...
const MIN = 160; // shortest a world can be
const MAX = 280; // tallest a world can be
const HERO_MIN = 230; // shortest a hero world can be
const HERO_MAX = 500; // tallest a hero world can be
const HERO_CHANCE = 0.4; // how often a section is capped with a hero world
